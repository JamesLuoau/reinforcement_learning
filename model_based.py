...
"""
Why need a model
a model to be able to predict the next position of the Cart given the previous position and an action

an agent can ‘imagine’ what it might be like to move around the real environment,
